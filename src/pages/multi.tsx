...
const MultiSelect = ({
  ...
  return (
    <div
      ...
      ref={wrapperRef}
      className="flex p-2 justify-between items-center relative rounded-xl border border-solid border-[#EAEAEA] text-base leading-6 text-gray-600  h-[48px] pl-3 ml-20 mt-5 w-[300px]"
    >
